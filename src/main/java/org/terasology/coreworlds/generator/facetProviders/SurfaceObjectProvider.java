...
/**
 * Places objects on the surface based on population densities for a environmental variable (e.g. biome).
 */
...
public abstract class SurfaceObjectProvider<B, T> implements FacetProvider {
     ...
     */
    protected void populateFacet(ObjectFacet3D<T> facet, SurfaceHeightFacet surfaceFacet,
                                 ObjectFacet2D<? extends B> typeFacet, List<Predicate<Vector3i>> filters) {
